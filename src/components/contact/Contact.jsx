        ...
        <motion.div
            ...
            <motion.div variants={variants} className="textContainer">
                ...
                <motion.div className="item">
                    ...
                    <motion.span>kelebekkadircan@gmail.com</motion.span>
                </motion.div>
                <motion.div className="item">
                    <motion.h2>Address</motion.h2>
                    <motion.span>Istanbul / Kücükcekmece / Istasyon Mahallesi</motion.span>
                </motion.div>
                <motion.div className="item">
                    <motion.h2>Phone</motion.h2>
                    <motion.span>0536 984 7114</motion.span>
                </motion.div>
            </motion.div>
